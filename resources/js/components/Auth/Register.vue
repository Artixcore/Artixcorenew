            ...
            <div class="card-body p-5">
              ...
              <form @submit.prevent="registerUser">
                <div class="mb-3">
                  ...
                  <input v-model="formData.name" class="form-control" type="text" placeholder="Name" required>
                </div>
                <div class="mb-3">
              ...
              <div>
                <p class="mb-0 text-center">
                  <router-link style="text-decoration: none;" to="/Login">Already have an account?</router-link>
                </p>
              </div>
